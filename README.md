# AUST Programming Sheet Solution
This repository contains solutions to various programming problems. The problems are categorized according to the PDF and each problem folder contains a solution file and a README file with the problem statement and explanation of the solution.
...
If you'd like to contribute to **AUST Programming Sheet Solution**, please follow these steps:

- Fork this repository.
- Choose a problem that you would like to solve and create a new branch for your solution.
